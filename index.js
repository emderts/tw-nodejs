...
.get('/test', (req, res) => res.render('pages/battle', {result: (new battlemodule.bmodule()).doBattle(JSON.parse(JSON.stringify(chara.ruisun)), JSON.parse(JSON.stringify(chara.gaius)), 1).result}))
