...
function procTest(testItem, resFile) {
  var testCount = 1000;
  var workbook = new excel.Workbook();
  var workSheet = workbook.addWorksheet('Test');
  ...
  for (itm of item.list.filter(x => x.id === testItem && x.type === cons.ITEM_TYPE_WEAPON)) {
    console.log(itm.name);
    var testResults = [];
    var testTurns = [];
    var rval = [];
  ...
  for (itm of item.list.filter(x => x.id === testItem && x.type === cons.ITEM_TYPE_ARMOR)) {
    console.log(itm.name);
    var testResults = [];
    var testTurns = [];
    var rval = [];
  ...
  for (itm of item.list.filter(x => x.id === testItem && x.type === cons.ITEM_TYPE_SUBARMOR)) {
    console.log(itm.name);
    var testResults = [];
    var testTurns = [];
    var rval = [];
  ...
  for (itm of item.list.filter(x => x.id === testItem && x.type === cons.ITEM_TYPE_TRINKET)) {
    console.log(itm.name);
    var testResults = [];
    var testTurns = [];
    var rval = [];
