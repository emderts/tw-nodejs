...
module.exports.procBattleStart = function (left, right, flag) {
  charLeft = left;
  charRight = right;
  _doBattleStart(flag);
...
module.exports.procBattleTurn = function (left, right, flag) {
  _doBattleTurn(left, right);
  if (redecide) {
    return {redecide: true, result: result};
  }
