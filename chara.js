...
const item = require('./items');
  ...
  effectObj.value = 0.7;
  skillObj.effect.push(effectObj);
  skillObj.tooltip = '100\% 확률로 자신에게 [흐름 관찰] 버프 부여<br><br>[흐름 관찰] : 준 피해의 70\%만큼의 보호막';
  ...
  effectObj = {code : cons.EFFECT_TYPE_MULTIPLE, chkHp : 0.2, chkNot : [201722],
      target : [{code : cons.EFFECT_TYPE_SELF_BUFF, buffCode : 201721, buffDur : 3},
                {code : cons.EFFECT_TYPE_SELF_HP, isPercentStat : true, percentKey : 'maxHp', value : 0.3},
                {code : cons.EFFECT_TYPE_SELF_BUFF, buffCode : 201722, buffDur : 8}]};
  skillObj.effect.push(effectObj);
  skillObj.tooltip = '턴 종료 시 자신에게 [에너지 코어] 버프가 없다면 100\% 확률로 자신에게 1턴간 [방전] 버프 부여 및 [에너지 코어] 버프 3중첩 부여, 추가로 현재 생명력이 20\% 이하일 시 최대 생명력의 30\%만큼 생명력을 즉시 회복하고 자신에게 3턴 간 [재구축 중..] 버프 부여<br><br>(재구축 회복은 전투당 1회)<br><br>[방전] : [기절] 상태이상, 종료 시 자신에게 5턴 간 [재구축] 버프 부여 (턴 종료 시 최대 생명력 3% 회복)<br>[재구축 중..] : 물리/마법 저항 -30\%p, SP 재생 0';
  ...
  effectObj.options.push(optObj);
  skillObj.effect.push(effectObj);
  skillObj.tooltip = '50\% 확률로 적에게 3턴간 [기절] 상태이상 부여 혹은 50\% 확률로 적에게 3턴간 [전류 방출] 버프 부여<br><br>[전류 방출] : 물리 저항 -25\%p, 회피 -15\%p';
  ...
  var skillObj = {code : 201751, name : '별빛쇄도', nameType : cons.NAME_KOR_NO_END_CONS, type : cons.DAMAGE_TYPE_MAGICAL, damage : 0.2, 
  ...
  skillObj = {code : 201772, name : '증폭', nameType : cons.NAME_KOR_END_CONS, type : cons.DAMAGE_TYPE_MAGICAL, damage : 0.8, 
      effect : [{code : cons.EFFECT_TYPE_SELF_BUFF, buffCode : 201777, buffDur : null, setStack : 1},
  ...
  skillObj = {code : 201773, name : '과부하', nameType : cons.NAME_KOR_NO_END_CONS, type : cons.DAMAGE_TYPE_MAGICAL, damage : 0.8,
      effect : [{code : cons.EFFECT_TYPE_SELF_BUFF, buffCode : 2017106, buffDur : null, value : 0.3},
                {code : cons.EFFECT_TYPE_SELF_BUFF, buffCode : 201779, buffDur : 3}],
      tooltip : '자신에게 3턴 간 [과부하] 버프 부여 및 (캐릭터의 물리+마법공격력)/30%만큼 보호막 부여<br><br>[과부하] : 보호막이 있을 때 피해를 받을 시 (물리저항+마법저항)만큼 피해 경감',
  ...
  function _initChar(char) {
    ...
    char.winRecord = {};
    char.dust = 0;
    char.dungeonInfos = {taurusReward : 3, enterMevious : 3, enterEmberCrypt : 3, enterBlacklight : 3, buyBlacklight : 0, enterIndigo : 3};
    char.currencies = {warlock : 0, aeika : 0, train : 0, indigo : 0};
    char.quest = {};
    char.stoneCube = [];
    char.birth = null;
    char.recentRecord = [];
    char.achievement = {};
    char.statistics = {damageDone : 0, maxDamageDone : 0, maxDamageDoneTo : '', damageTaken : 0, maxDamageTaken : 0, maxDamageTakenFrom : '', 
        atkCnt : 0, atkRecvCnt : 0,
