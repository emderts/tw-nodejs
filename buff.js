...
module.exports.getBuffData = function(eff) {
  ...
  case 90015 : 
    ...
    effectObj.code = cons.EFFECT_TYPE_SET_SKILL;
    effectObj.key = 'special';
    effectObj.target = {code : 90052, name : '껍질깨기', nameType : cons.NAME_KOR_NO_END_CONS, type : cons.SKILL_TYPE_SPECIAL, cost : 70, 
  ...
  case 90020 : 
    ...
    effectObj.key = 'base';
    effectObj.value = 0;
    effectObj.target = {code : 90053, name : '이상한빛', nameType : cons.NAME_KOR_NO_END_CONS, type : cons.DAMAGE_TYPE_MAGICAL, damage : 0.1, 
    ...
    effectObj.key = 'base';
    effectObj.value = 1;
    effectObj.target = {code : 90054, name : '번개', nameType : cons.NAME_KOR_END_CONS, type : cons.DAMAGE_TYPE_MAGICAL, damage : 1.6, 
